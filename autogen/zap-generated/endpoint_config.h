...
\
  ...
  { (uint16_t)0x5A, (uint16_t)0x0, (uint16_t)0xFFFE } /* PIR occupied to unoccupied delay */ \
}
...
\
  ...
  { 0x00000002, ZAP_TYPE(BITMAP8), 1, 0, ZAP_SIMPLE_DEFAULT(1) }, /* occupancy sensor type bitmap */  \
  { 0x00000010, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_MIN_MAX_DEFAULTS_INDEX(1) }, /* PIR occupied to unoccupied delay */  \
  { 0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0, ZAP_SIMPLE_DEFAULT(0) }, /* FeatureMap */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 19, 235 }, \
  { ZAP_CLUSTER_INDEX(19), 3, 26 }, \
}
