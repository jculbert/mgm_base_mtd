#ifndef SL_EMLIB_GPIO_INIT_PANASONIC_VDD_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PANASONIC_VDD_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PANASONIC_VDD_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PANASONIC_VDD_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_PANASONIC_VDD_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PANASONIC_VDD_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_PANASONIC_VDD
// $[GPIO_SL_EMLIB_GPIO_INIT_PANASONIC_VDD]
#define SL_EMLIB_GPIO_INIT_PANASONIC_VDD_PORT    gpioPortC
#define SL_EMLIB_GPIO_INIT_PANASONIC_VDD_PIN     4
// [GPIO_SL_EMLIB_GPIO_INIT_PANASONIC_VDD]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PANASONIC_VDD_CONFIG_H
