#ifndef SL_EMLIB_GPIO_INIT_MOTION_INPUT_CONFIG_H
#define SL_EMLIB_GPIO_INIT_MOTION_INPUT_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_MOTION_INPUT_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_MOTION_INPUT_MODE        gpioModeInputPull

// <o SL_EMLIB_GPIO_INIT_MOTION_INPUT_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_MOTION_INPUT_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_MOTION_INPUT
// $[GPIO_SL_EMLIB_GPIO_INIT_MOTION_INPUT]
#define SL_EMLIB_GPIO_INIT_MOTION_INPUT_PORT     gpioPortD
#define SL_EMLIB_GPIO_INIT_MOTION_INPUT_PIN      3
// [GPIO_SL_EMLIB_GPIO_INIT_MOTION_INPUT]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_MOTION_INPUT_CONFIG_H
